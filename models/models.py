...
class hrcontract_salary(models.Model):
    ...
    salarioquin = fields.Float(string='Salario quincenal')
    amount_to_text_salary = fields.Char(string="Salario quincenal en texto")
    sueldo_a_pagar = fields.Float(string='Sueldo diario a pagar')
    amount_to_text_sueldo = fields.Char(string="Sueldo a pagar en texto")
